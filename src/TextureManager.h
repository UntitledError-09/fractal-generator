...
public:
     ...
     * 
     * Transitions the texture from its current layout to one suitable
     * for sampling in the fragment shader.
     * 
     * @param commandBuffer Command buffer to record transition commands
     * @param oldLayout Current layout of the texture
     * @param newLayout Target layout for the texture
     */
