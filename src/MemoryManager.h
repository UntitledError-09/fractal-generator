...
public:
     ...
     * @param persistentMap Whether to keep the buffer mapped (for CPU-visible memory)
     ...
     */
    std::shared_ptr<BufferInfo> createBuffer(
    ...
    // TODO(Phase 3): Add image allocation utilities
...
private:
    ...
    std::unordered_map<std::string, std::shared_ptr<BufferInfo>> m_buffers; ///< Tracked buffers
