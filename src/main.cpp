 ...
 * and handles any errors that occur during execution. This function
 * demonstrates modern C++ exception handling and RAII principles.
 *
...
int main(int argc, char *argv[]) {
  // TODO(Future): Add command line argument parsing for configuration
  // Potential args: --width, --height, --fullscreen, --validation,
  // --fractal-type
